    ...
    return (
        <Navbar bg="dark" variant="dark">
            <Container>
                ...
                <Navbar.Brand ><img className="Logo" src="http://mercadocampesino.com.co/wp-content/uploads/2020/10/LOGO-MERCADO-CAMPESINOok.png" alt="Logo"/></Navbar.Brand>
            ...
            </Container>
            {
                ...
                <button onClick={()=> loginWithRedirect()} className="btn btn-primary"> {textButton}</button>
            }    
        </Navbar>
    )
}
